...
export default function QuizScreen() {
    ...
    easy: [
      {
        ...
        correct: 0,
        explanation:
          "ML stands for Machine Learning - a method of data analysis that automates analytical model building.",
      },
      {
        ...
        correct: 0,
        explanation:
          "Supervised Learning is one of the main types of machine learning where algorithms learn from labeled training data.",
      },
      {
        question: "What is data in machine learning?",
        options: [
          "Information used to train models",
          "Computer hardware",
          "Software code",
          "Internet connection",
        ],
        correct: 0,
        explanation:
          "Data is the information or examples used to train machine learning models to make predictions or decisions.",
      },
    ],
    medium: [
      {
        ...
        correct: 1,
        explanation:
          "Machine learning's main goal is to identify patterns in data and use them to make accurate predictions on new, unseen data.",
      },
      {
        ...
        correct: 2,
        explanation:
          "Decision Trees are widely used for classification tasks as they can handle both categorical and numerical data effectively.",
      },
      {
        ...
        correct: 0,
        explanation:
          "Overfitting occurs when a model learns the training data too specifically, including noise, making it perform poorly on new data.",
      },
    ],
    hard: [
      {
        ...
        correct: 1,
        explanation:
          "Lasso Regression uses L1 regularization, which adds a penalty equal to the sum of absolute values of parameters, often leading to sparse models.",
      },
      {
        ...
        correct: 1,
        explanation:
          "The curse of dimensionality refers to various phenomena that arise when analyzing data in high-dimensional spaces, where data becomes increasingly sparse.",
      },
      {
        question:
        ...
        correct: 2,
        explanation:
          "PCA (Principal Component Analysis) reduces dimensionality by finding principal components that capture the maximum variance in the data.",
      },
    ],
  };
  ...
  const generateAdaptiveQuestion = (
    ...
    if (responseTime < 8 && isCorrect && userPerformance.streak >= 2) {
      ...
      responseTime > 20 ||
      !isCorrect ||
      userPerformance.correctRate < 0.5
    ) {
      difficulty = "easy";
    }
    ...
    const availableQuestions = questions.filter(
      (q) => !adaptiveQuestions.some((aq) => aq.question === q.question)
    );
  ...
  const handleAnswer = (answerIndex: number) => {
    ...
    if (isCorrect) {
      setScore(
        (prev) => prev + (timeLeft > 20 ? 100 : timeLeft > 10 ? 80 : 60)
      );
    }
      ...
      <Screen>
        <View className="flex-1 justify-center items-center px-6">
          <View className="bg-white rounded-3xl p-8 w-full max-w-sm items-center">
            ...
            <ThemedText
              style={{ color: "#4b5563", textAlign: "center", marginBottom: 8 }}
            >
      ...
      <View className="flex-1">
        ...
        <View className="px-6 pt-4 pb-6">
          <View className="flex-row items-center justify-between mb-4">
            ...
            <ThemedText type="defaultSemiBold" style={{ color: "#34d399" }}>
              {score} pts
            </ThemedText>
          </View>
          ...
          {/* small humane tip */}
          <ThemedText style={{ color: "#d1fae5", marginTop: 6 }}>
            Tip: Breathe. Answer calmly — speed helps, but accuracy wins.
          </ThemedText>
          ...
          <View className="bg-white rounded-3xl p-6 mb-6">
            <View className="mb-4">
              <Text className="text-sm text-gray-500 mb-2">
                🧠{" "}
                {userPerformance.avgResponseTime < 10
                  ? "Advanced"
                  : userPerformance.avgResponseTime > 20
                  ? "Beginner"
                  : "Intermediate"}{" "}
                Level
              </Text>
              ...
              {currentQ?.options.map((option: string, index: number) => (
                ...
                >
                  <View className="flex-row items-center justify-between">
                    <Text className="font-semibold flex-1 text-lg">
                      {option}
                    </Text>
                    {showResult && index === currentQ.correct && (
